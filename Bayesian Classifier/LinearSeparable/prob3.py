...
def calculate_co_variance_matrix_C(cov):
    average=0.0
    for i in range(dimension):
        for j in range(dimension):
            average=average+cov[i][j]
...
def calculate_inverse_matrix(cov_matrix_b):
  ...
  if(cov_matrix_b[0][1]==0):
    cov_matrix_b[0][1]=0
  if(cov_matrix_b[1][0]==0):
    cov_matrix_b[1][0]=0
...
def calculate_w2(cov):
    w2=[[0 for i in range(2)] for j in range(2)]
    for i in range(2):
        for j in range(2):
            w2[i][j]=(w2[i][j]/(-2))
...
def main():
    ...
    cov_X_CLASS_1=calculate_co_variance_matrix_C(cov_X_CLASS_1)
    ...
    cov_X_CLASS_2=calculate_co_variance_matrix_C(cov_X_CLASS_2)
    ...
    cov_X_CLASS_3=calculate_co_variance_matrix_C(cov_X_CLASS_3)
